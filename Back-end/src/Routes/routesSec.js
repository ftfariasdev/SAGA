...
routerSec.delete(
  '/sec/excluirMateria/:id_materia',
  tokenAuthenticate,
  secController.excluirMateria
);
...
routerSec.get(
  '/sec/consultarProfessor/:id_user',
  tokenAuthenticate,
  secController.consultarProfessor
);
routerSec.get(
  '/sec/consultarSecretaria/:id_user',
  tokenAuthenticate,
  secController.consultarSecretaria
);

// Rotas para atualização de dados específicos
routerSec.put(
  '/sec/atualizarTurmaAluno/:id_user',
  tokenAuthenticate,
  secController.atualizarTurmaAluno
);
routerSec.put(
  '/sec/atualizarEspecialidadeProfessor/:id_user',
  tokenAuthenticate,
  secController.atualizarEspecialidadeProfessor
);
routerSec.put(
  '/sec/atualizarSetorSecretaria/:id_user',
  tokenAuthenticate,
  secController.atualizarSetorSecretaria
);
routerSec.get(
  '/sec/listarTurmasProfessor/:id_user',
  tokenAuthenticate,
  secController.listarTurmasProfessor
);
routerSec.put(
  '/sec/atualizarTurmasProfessor/:id_user',
  tokenAuthenticate,
  secController.atualizarTurmasProfessor
);
...
routerSec.delete(
  '/sec/Turma/removerAluno/:id_aluno',
  tokenAuthenticate,
  secController.removerAlunoTurma
);
routerSec.delete(
  '/sec/Turma/removerProfessor/:id_professor/:id_turma',
  tokenAuthenticate,
  secController.removerProfessorTurma
);
